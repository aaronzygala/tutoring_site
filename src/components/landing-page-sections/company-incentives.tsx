            ...
            <div 
              className="grid lg:grid-cols-2 lg:px-24 mt-12 justify-evenly">
                <div
                  ...
                  >
                      <CardTest   
                                  ...
                                  description={"During our Live Lessons we provide 1:1 support directly in Zoom. \
                                                Every week you'll join mentorship sessions to build your confidence."}
                                  imageSrc={PrivateLessons}
                                  imageAltDescription={"An image showing a teacher having a 1 on 1 tutoring session with their student"} />
                  </div>
                  <div
                      data-aos="fade-up"
                      data-aos-once="true"
                  ...
                  >
                      <CardTest   title={"Realistic Exams"}
                                  description={"Be prepared for the SAT, ACT and CLT exams by taking practice exams that mimic the real thing!"}
                ...
                <div
                  ...
                  >
                      <CardTest   title={"Custom Lesson Plans"}
                                  description={"Personalized plans designed by your teacher to maximize your learning potential.\
                                                Every student is unique, and we're ready to help."}
                  ...
                  >
                      <CardTest   title={"Experienced Teachers"}
                                  description={"We have a team of experienced math instructors with 99th-percentile SAT scores.\
                                                Our students will be personally guided by the best possible teachers."}
                                  imageSrc={CustomLessonPlans}
                                  imageAltDescription={"An image showing an agenda for a tutor's student."} />
                  </div>
            </div>
